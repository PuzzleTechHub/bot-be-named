...
os.system(f"ffmpeg -y -f lavfi -i anullsrc=r=44100:cl=mono -t 5 -q:a 9 -acodec libmp3lame {os.path.join(music_race_constants.PUZZLE_PARTIAL_SONGS_DIR, 'silence.mp3')}")
