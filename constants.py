...
VERIFIED = [TA_VERIFIED_PUZZLER1_ROLE_ID, TA_VERIFIED_PUZZLER2_ROLE_ID, SONI_SERVER_TESTER_ROLE, KEV_SERVER_TESTER_ROLE, SONI_SERVER_VERIFIED_ROLE]
TRUSTED = [ARITHMANCY_BOT_WHISPERER_ROLE_ID, SONI_SERVER_TESTER_ROLE, KEV_SERVER_TESTER_ROLE, TA_VET_ID, TA_MOD_ID, SONI_SERVER_VERIFIED_ROLE]
